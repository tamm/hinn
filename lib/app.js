...
var app = angular.module('Hinn', [
    ...
    .controller('HinnController', [
        ...
        var getLocationById = function (locationId) {
            ...
            console.log('getLocationById can not fetch right now');
            return $q(function (resolve, reject) { resolve(false); });
            // var locationUrl = vasttrafikApiUrl + '/location.id';
            // params = {
            //     'format': 'json',
        ...
        var updateLocation = function (newVal, oldVal) {
            if (newVal !== oldVal) {
                ...
                if ($scope.departure) {
                    ...
                    if ($scope.departure.stopid) {
                        ...
                        getLocationById($scope.departureLocation).then(function(response) {
                            console.log('getLocationById departure',response);
        ...
        var initOriginAndDestination = function () {
            ...
            if (!$scope.origin && search.origin) {
                ...
                getLocationById($scope.origin).then(function(response) {
                    console.log('getLocationById origin',response);
            ...
            if (!$scope.destination && search.destination) {
                ...
                getLocationById($scope.destination).then(function(response) {
                    console.log('getLocationById destination',response);
